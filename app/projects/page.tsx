...
const projects = [
  ...
  },
  {
    ...
    description: "Personal portfolio showcasing projects and skills, built with Next.js and Tailwind CSS",
    imageUrl: "/placeholder.svg?height=200&width=300",
    githubUrl: "https://github.com",
    liveUrl: "https://example.com",
  },
  ...
  {
    title: "Blog CMS",
    description: "Content Management System for blogs with markdown support and user authentication",
    imageUrl: "/placeholder.svg?height=200&width=300",
    githubUrl: "https://github.com",
    liveUrl: "https://example.com",
  },
